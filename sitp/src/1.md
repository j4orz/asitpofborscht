...
- [1.2 Next Token Prediction is Classification](#12-next-token-prediction-is-classification)
  ...
  - [1.2.2 The Joint, Marginal, and Conditional]()
  - [1.2.3 Counting Markov Biased Histograms](#122-counting-markov-biased-histograms)
...
The code for this joint is the transliteration of the matrix from Figure I.2.3 into `np.ndarray` with `.shape`of `(5,5)` (todo, curry by indexing into first or second):
