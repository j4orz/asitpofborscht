...
- length with **Euclidean norm**<span class="defnote">**Euclidean norm**</span> $\mathcal{l}_1$
- length with **Manhattan norm**<span class="defnote">**Manhattan norm**</span> $\mathcal{l}_2$
