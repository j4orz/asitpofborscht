...
- [1. Self-Supervised Sequence Learning with Single-Layer Networks](#1-self-supervised-sequence-learning-with-single-layer-networks)
  ...
  - [1.3 Parameterizing Classification with Logistic Regression](#13-parameterizing-classifcation-with-logistic-regression)
    ...
    - [1.3.2 Architecture with Logistic Regression](#132-architecture-with-logistic-regression)
    - [1.3.3 Loss Function with Cross Entropy Loss]()
    - [1.3.4 Optimization with Iterative Reweighted Least Squares]()
    - [1.3.5 Probabilistic and Decision Theoretic Perspective]()
    - [1.3.6 Evaluation with Bias Variance Tradeoff]()
  - [1.4 Parameterizing Quantification with Linear Regression](#14-parameterizing-quantification-with-linear-regression) <!-- with least squared error -->
    - [1.4.1 Architecture with Linear Regression](#131-architecture-with-logistic-regression)
    - [1.4.2 Loss Function with Least Squares](#132-loss-function-with-cross-entropy-loss)
    - [1.4.3 Optimization with Normal Equations](#133-optimizing-loss-with-iterative-reweighted-least-squares)
    - [1.4.4 Optimization with Decompositions]()
    - [1.4.5 Probabilistic and Decision Theoretic Perspective]()
    - [1.4.6 Evaluation with Bias Variance Tradeoff]()
- [Intermezzo One: The Language of Continuous Mathematics](#intermezzo-one-the-language-of-continuous-mathematics)
  ...
  - [I.2 Fields, Vector Spaces]()
  - [I.3 Inner Product Spaces, Normed Spaces]()
  - [I.4 Measurable Spaces, Probability Spaces]()
  - [I.5 Convex Sets]()
...
> In which we transition to the stochastic and infinitely continuous software 2.0 by implementing ngram and linear language models with <img class="icon" src="./assets/borscht.png" alt="" style="aspect-ratio: 736 / 510;">[`borscht.Tensor`]() using the languages of probability theory, linear algebra, and calculus.
...
- [1.3 Parameterizing Classification]()
  ...
  - [1.3.3 Probabilistic Architecture with Logistic Regression]()
  - [1.3.4 Loss Function with Cross Entropy Loss]()
  - [1.3.5 Optimization with Iterative Reweighted Least Squares]()
  - [1.3.6 Probabilistic and Decision Theoretic Perspective]()
...
#### 1.3.5 Optimizing Loss with Iterative Reweighted Least Squares
...
### 1.4 Parameterizing Quantification with Linear Regression  <!-- with Least Squared Error -->
<small>[$\hookleftarrow$ Table of Contents](#i-table-of-contents)</small>
...
- [1.4 Parameterizing Quantification]()
  - [1.4.1 Architecture with Linear Regression](#141-architecture-with-linear-regression)
  - [1.4.2 Loss Function with Least Squares](#142-loss-function-with-least-squares)
  - [1.4.3 Optimization with Normal Equations](#143-optimization-with-normal-equations)
  - [1.4.4 Optimization with Decompositions](#144-optimization-with-decompositions)
  - [1.4.5 Probabilistic and Decision Theoretic Perspective]()
  - [1.4.6 Evaluation with Bias Variance Tradeoff]()

</div>

#### 1.4.1 Architecture with Linear Regression
...
#### 1.4.2 Loss Function with Least Squares
...
#### 1.4.3 Optimization with Normal Equations
...
- [Intermezzo One: The Language of Continuous Mathematics]()
  - [I.1 Sets, Functions, and Relations]()
  - [I.2 Fields, and Vector Spaces]()
  - [I.3 Inner Product Spaces, Normed Spaces]()
  - [I.4 Measurable Spaces, Probability Spaces]()
</div>
