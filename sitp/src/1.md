...
- [2. The Massively Parallel Multidimensional Tensor](#2-the-multidimensional-tensor)
  ...
  - [2.3 Accelerating Matrix Multiplication on CPUs](#23-accelerating-matrix-multiplication-with-cpus) <!-- with computation and communication of rooflines -->
  - [2.4 Accelerating Matrix Multiplication on GPUs](#24-accelerating-matrix-multiplication-with-gpus) <!-- simd to simt -->
  - [2.5 Accelerating Matrix Multiplication on TPUs](#25-accelerating-matrix-multiplication-with-tpus) <!-- gpu to tpu -->
...
Where first five $\mathbf{x}^{(i)}$'s are plotted with [`plt.imshow`](https://matplotlib.org/stable/api/_as_gen/matplotlib.pyplot.imshow.html)
...
f:V &\to V\\
v &\mapsto I^{-1} \circ \text{rng} \circ P \circ I(v)
...
### 2.3 Accelerating Matrix Multiplication with CPUs
<small>[$\hookleftarrow$ Table of Contents (§2. The Multidimensional Tensor)](#2-the-multidimensional-tensor)</small>
...
### 2.4 Accelerating Matrix Multiplication with GPUs
<small>[$\hookleftarrow$ Table of Contents (§2. The Multidimensional Tensor)](#2-the-multidimensional-tensor)</small>
...
### 2.5 Accelerating Matrix Multiplication with TPUs
<small>[$\hookleftarrow$ Table of Contents (§2. The Multidimensional Tensor)](#2-the-multidimensional-tensor)</small>
