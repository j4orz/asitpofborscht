...
- [1. Self-Supervised Sequence Learning with Single-Layer Networks](#1-sequence-learning)
  ...
  - [1.4 Categorical Parameterization with Logistic Regression](#13-categorical-parameterization-with-logistic-regression)
  - [1.5 Quantitative Redux with Linear Regression](#14-Lagniappe-fitting-linear-regression) <!-- with least squared error -->
...
- [1.2 Next Token Prediction with Bigrams]()
  ...
  - [1.2.3 Architecture with Markov Assumption](#123-architecture-with-markov-assumption)
...
As mentioned in the previous chapter, large language models are trained using methods from the discipline of <span class="defnote">**deep learning**</span>**deep learning**, in turn that are based in <span class="defnote">**machine learning**</span>**machine learning**,
which *itself* is founded in <span class="defnote">**statistics**</span>**statistics**.
...
That is, the former is given a model and <span class="defnote">**generation**</span>**generates** data, whereas the latter is given data and <span class="defnote">**estimation**</span>**estimates** the model.
...
- (prediction vs inference, two cultures)
...
#### 1.2.3 Architecture with Markov Assumption
...
- [1.3 Categorical Parameterization]()
  - [1.3.1 Parameterization]()
  - [1.3.2 Architecture with Logistic Regression]()
  - [1.3.3 Loss Function with Cross Entropy Loss]()
  - [1.3.4 Optimization with Gradient Descent]()
  - [1.3.5 Evaluation]()
...
### 1.4 Quantitative Redux with Linear Regression  <!-- with Least Squared Error -->
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
