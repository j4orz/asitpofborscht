...
- [2. The Multidimensional Tensor](#2-the-multidimensional-tensor)
  - [2.1 The Three Language Problem]()
  - [2.2 Virtualizing Shapes with Strides]()
  - [2.3 Accelerating Matrix Multiplication with Multi Cores]() <!-- with computation and communication of rooflines -->
  - [2.4 Accelerating Matrix Multiplication with Many Cores]() <!-- simd to simt -->
  - [2.5 Accelerating Matrix Multiplication with Tensor Cores]() <!-- gpu to tpu -->
...
> In which we introduce the terminology of software 2.0 in the context of language modeling; implement our first language model by maximizing the likelihood of biased ngrams; evaluate said model and it's limits with information theoretical and probabilistic quantities such as perplexity, entropy, bias variance tradeoff, and the curse of dimensionality to be also applied to linear and logistic regression models in the following chapters; and understand the naturalization of intelligence more generally as compression.
...
## 2. The Multidimensional Tensor
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>

<div class="toc">

- [2. The Multidimensional Tensor](#2-from-ipls-array-to-apls-multidimensional-array)
  - [2.1 The Three Language Problem]()
  - [2.2 Virtualizing Shapes with Strides]()
...
### 2.3 Accelerating Matrix Multiplication with Multicore CPUs
<small>[$\hookleftarrow$ Table of Contents (§2. The Multidimensional Tensor)](#2-the-multidimensional-tensor)</small>
...
### 2.4 Accelerating Matrix Multiplication with Manycore GPUs
<small>[$\hookleftarrow$ Table of Contents (§2. The Multidimensional Tensor)](#2-the-multidimensional-tensor)</small>

### 2.5 Accelerating Matrix Multiplication with Tensorcore TPUs
<small>[$\hookleftarrow$ Table of Contents (§2. The Multidimensional Tensor)](#2-the-multidimensional-tensor)</small>

### 2.6 From Strides to Layouts
<small>[$\hookleftarrow$ Table of Contents (§2. The Multidimensional Tensor)](#2-the-multidimensional-tensor)</small>

### 2. Accelerating Matrix Multiplication Redux
<small>[$\hookleftarrow$ Table of Contents (§2. The Multidimensional Tensor)](#2-the-multidimensional-tensor)</small>
<!-- loop unroll -->
