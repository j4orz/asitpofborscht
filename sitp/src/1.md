...
- [2. The Multidimensional Parallelized Tensor](#2-the-massively-parallel-multidimensional-tensor)
  - [2.1 Virtualizing Shapes with Strides](#22-virtualizing-shapes-with-strides)
  ...
  - [2.2 Accelerating Basic Linear Algebra on CPUs](#23-accelerating-matrix-multiplication-on-cpus) <!-- with computation and communication of rooflines -->
...
If you'd like to learn Rust on it's own,
we recommend [TRPL (Klabnick, Nichols, Krycho)](https://rust-book.cs.brown.edu/)
