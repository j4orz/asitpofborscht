...
- [1.3 Parameterizing Classification]()
  - [1.3.1 From Discrete Data to Dimensional Data](#131-from-discrete-data-to-dimensional-data)
  - [1.3.2 From Coding Function Bodies to Optimizing Loss Functions]()
...
How can the decision boundary $l$ be defined as a set of points satisfying the property that their weighted sum with the vector $\cparam{w}$ is 0? Where is the $y=mx+b$ we all know from grade school?
...
#### 1.3.2 Optimization with Least Squares
