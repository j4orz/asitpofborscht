...
- [1.3 Parameterizing Classification]()
  - [1.3.1 From Coding Discrete Data to Optimizing Dimensional Data](#131-from-coding-discrete-data-to-optimizing-dimensional-data)
...
#### 1.3.1 From Coding Discrete Data To Optimizing Dimensional Data
...
Consider Figure X.Y.Z,
namely with the **weights**<span class="defnote">**weights**</span> $w_i$ and **biases**<span class="defnote">**bias**</span> $b$ of a **linear regression**<span class="defnote">**linear regression**</span> model which can also be viewed as a single **neuron**<span class="defnote">**neuron**</span> from a deep net.
...
Recall from [§1.1.2 Probability as Array Programming](), we
took the so-called "computer scientist" view of vectors without any induced geometry. Now it is time for us to broaden our horizons, and expand our conceptualization of the notion of **vectors**<span class="defnote" data-refine="vector">**vector**</span> not only as lists, but also as *points in a high dimensional space with a geometry*.

  <img src="./assets/discriminant_dark.png" alt="" style="display: block; margin: 0 auto;">
