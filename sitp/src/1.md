...
<img src="./assets/discriminant_weightbad_dark.png" alt="" style="display: block; margin: 0 auto;">
...
$$
\cout{y} = \hat{f}(\cin{\mathbf{x}}):= \cfun{\sum \limits_{i=1}^{d}}\cparam{w_i} \cin{x_i}
$$
