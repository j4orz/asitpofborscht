...
and $Q: \Delta^{|V|} \times [0,1) \to \N$ mapped such distributions to one specific word class index, with the final $I^{-1}: \N \to V$ decoding the sampled index back into the actual word.
