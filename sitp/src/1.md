...
- [1. Self-Supervised Sequence Learning with Single-Layer Networks](#1-sequence-learning)
  ...
  - [1.3 Categorical Parameterization with Logistic Regression](#13-categorical-parameterization-with-logistic-regression)
  - [1.4 Quantitative Lagniappe with Linear Regression](#14-Lagniappe-fitting-linear-regression) <!-- with least squared error -->
  - [1.5 Bias Variance Tradeoff](#16-directly-fitting-linear-regression-with-least-squared-error) <!-- with least squared error -->
  - [1.6 Summary](#16-summary)
  - [1.7 Further Reading](#17-further-reading)
  - [1.8 Problems](#18-problems)
...
### 1.3 Categorical Parameterization with Logistic Regression <!-- with Cross Entropy Loss $\mathscr{L(\theta)} := $ -->
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
...
- [1.3 Categorical Parameterization]()
  ...
  - [1.3.3 Optimization with Gradient Descent]()
  - [1.3.4 Evaluation]()
...
### 1.4 Quantitative Lagniappe  <!-- with Least Squared Error -->
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
