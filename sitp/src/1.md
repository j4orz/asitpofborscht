...
- [1. Self-Supervised Sequence Learning with Single-Layer Networks](#1-self-supervised-sequence-learning-with-single-layer-networks)
  ...
  - [1.5 Summary and Further Reading](#15-summary-and-further-reading)
...
> In which we transition to the stochastic and infinitely continuous software 2.0 by implementing ngram and linear language models with <img class="icon" src="./assets/borscht.png" alt="" style="aspect-ratio: 736 / 510;">[`borscht`]() using the languages of probability theory.
...
<img src="./assets/neuron_linreg.png" alt="" style="display: block; margin: 0 auto;">
...
<img src="./assets/discriminant_decisionbad_dark.png" alt="" style="display: block; margin: 0 auto;">

<img src="./assets/discriminant_decision_dark.png" alt="" style="display: block; margin: 0 auto;">

</div>
<small>Fijgure I.2.3</small>

Given that $\cparam{\mathbf{w}}$ is the only term left from the neuronal circuit not mentioned,
you may have already surmised that such a decision boundary $l$ is *determined* by the weight vector $\cparam{\mathbf{w}}$, summed by the input vector $\cin{\mathbf{x}}$ with a weighted sum $\cfun{\sum}$. That is, the decision boundary $l$ is the set of points

$$\{\cin{\mathbf{x}} : \cfun{\sum \limits_{i=1}^{d}}\cparam{w_i} \cin{x_i} = 0 \}$$
...
**orthogonal**<span class="defnote">**orthogonal**</span>
...
<img src="./assets/discriminant_weight_bad_dark.png" alt="" style="display: block; margin: 0 auto;">

<img src="./assets/discriminant_weight_dark.png" alt="" style="display: block; margin: 0 auto;">
...
let us formalize the previously notions encountered from the languages of probability, linear algebra, and differential calculus. For further reading, we recommend consulting [(Durrett (2019)](https://sites.math.duke.edu/~rtd/PTE/pte.html)
