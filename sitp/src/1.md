...
Now that we understand the process of language modelling is classification under a self-supervised setting, how do we go about actually estimating the distribution $p(w|\mathbf{h})$?
