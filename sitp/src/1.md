...
Because we are only taking the top 10 most likely words, `.shape` is `(10,)` with support in $\reals^{10}$.
We now shift our attention to implementing functions like GPT-2 that can produce such a conditional distribution $p(w|\mathbf{h})$.
...
or <span class="defnote">**representation learning**</span>**representation learning**, in turn that are based in <span class="defnote">**machine learning**</span>**machine learning**,
which *itself* is founded in <span class="defnote">**statistical learning**</span>**statistics**<span class="sidenote-number"></span><span class="sidenote">*Actually, learning is also possible to implement with logical and finitely discrete methods of software 1.0 via (todo).*</span>.
Generally speaking, the difference between probability and statistics is that of <span class="defnote">**prediction**</span>**prediction** and <span class="defnote">**inference**</span>**inference**,
where the former is given a model and <span class="defnote">**generation**</span>**generates** data, whereas the latter is given data and <span class="defnote">**estimation**</span>**estimates** the model.
...
<!-- <div class="full-bleed">
<iframe loading="lazy" height="1000px" src="https://setosa.io/ev/conditional-probability/"></iframe></div> -->

#### 1.2.3 Non-Parametric Histogram with Markov Assumption
Clearly, deriving the conditional distribution from the joint distribution is intractable (todo, show counting...).
...
### 1.4 Categorical Parameterization with Logistic Regression <!-- with Cross Entropy Loss $\mathscr{L(\theta)} := $ -->
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
