...
> In which we introduce the probabilistic basics of language modeling with GPT-2 and teenygrad.
...
We can validate that `probs` is a valid distribution by verifying that each probability is between 0-1 and the distribution normalizes to 1.
