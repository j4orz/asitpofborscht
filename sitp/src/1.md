...
- [1.2 Next Token Prediction with Bigrams]()
  ...
  - [1.2.2 Joint, Conditional, and Product Rule](#122-joint-conditional-and-product-rule)
  - [1.2.3 Non-Parametric Histogram with Markov Assumption]()
  - [1.2.4 Counting Bigrams]()
  - [1.2.5 Loss Function with Maximum Likelihood Estimate]()
...
which *itself* is founded in <span class="defnote">**statistical learning**</span>**statistics**.
...
(todo, terminology for forward doesn't seem right. predictive model vs discriminative model vs generative model?)
(todo, briefly touch on ml vs dl.)
...
#### 1.2.2 Joint, Conditional, and Product Rule
...
#### 1.2.4 Loss Function with Maximum Likelihood Estimation
...
#### 1.3.1 Architecture with Single Layer Network
...
#### 1.3.2 Optimization with Gradient Descent
