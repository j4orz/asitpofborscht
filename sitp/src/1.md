...
- [2. The Multidimensional Parallelized Tensor](#2-the-massively-parallel-multidimensional-tensor)
  - [2.1 Virtualizing Shapes with Strides](#21-virtualizing-shapes-with-strides)
    ...
    - [2.1.2 A Stride Maps a Logical Shape to a Physical Storage]()
    - [2.1.3 Implementing vector addition `saxpy`]()
    - [2.1.4 Implementing matrix vector multiplication `sgemv`]()
    - [2.1.5 Implementing matrix matrix multiplication `sgemm`]()
...
- [2. The Massively Parallel Multidimensional Tensor](#2-from-ipls-array-to-apls-multidimensional-array)
  - [2.1 Virtualizing Shapes with Strides](#21-virtualizing-shapes-with-strides)
    - [2.1.1 From `python` to `rust`]()
    - [2.1.2 A Stride Maps a Logical Shape to a Physical Storage]()
    - [2.1.3 Implementing Matrix Vector Operations: `saxpy`, `sgemv` and `sgemm`]()
    - [2.1.4 Implementing Reductions]()
    - [2.1.5 Implementing Broadcasts]()
    - [2.1.6 Implementing Views]()
    - [2.1.7 Implementing Indexing]()
  - [2.2 Accelerating Basic Linear Algebra on CPUs](#22-accelerating-matrix-multiplication-on-cpus) <!-- with computation and communication of rooflines -->
    - [2.2.1 From `rust` to `risc-v`]()
    - [2.2.2 Instruction Sets, Pipelines, and Hierarchies]()
    - [2.2.3 Measuring Bottlenecks to Throughput with Roofline Plots]()
...
[(Eijkhout 2022)](https://theartofhpc.com/istc.html) for performance engineering<span class="sidenote-number"></span><span class="sidenote">*If Eijkhout is not your cup of tea, take a look at [(Bryant, O'Hallaron 2003)](https://www.cs.sfu.ca/~ashriram/Courses/CS295/assets/books/CSAPP_2016.pdf)*</span>,
and [(Hennessy and Patterson 2025)](https://www.educate.elsevier.com/book/details/9780443154065) for computer architecture<span class="sidenote-number"></span><span class="sidenote">*If Hennessy and Patterson is not your cup of tea, take a look at [(Harris and Harris 2021)](https://www.cs.sfu.ca/~ashriram/Courses/CS295/assets/books/CSAPP_2016.pdf)*</span>.
...
> In which we introduce the so-called *three language problem* that numerical frameworks such as <img class="icon" src="./assets/borscht.png" alt="" style="aspect-ratio: 736 / 510;">[`borscht`](https://github.com/j4orz/borscht), and `torch` suffer from, namely using one language for productivity, one for native performance on host, and another for native performance on device.

<div class="toc">

- [2.1 The Three Language Problem]()
  - [2.1.1 From `python` to `rust`]()
  - [2.1.2 From `rust` to `risc-v`]()
  - [2.1.3 Instruction Sets for Pipelines, and Hierarchies]()
...
- [2.3 Accelerating Matrix Multiplication on CPUs]()
  - [2.3.1 Measuring Bottlenecks to Throughput with Roofline Plots]()
  - [2.3.2 Accelerating `SAXPY` on `RISC-V`]()
  - [2.3.3 Accelerating `SGEMV` on `RISC-V`]()
  - [2.3.4 Accelerating `SGEMM` on `RISC-V`]()
