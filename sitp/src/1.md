...
- [Intermezzo One: The Language of Continuous Mathematics](#intermezzo-one-the-language-of-continuous-mathematics)
  ...
  - [I.5 Convex Sets]()
- [2. The Multidimensional Parallelized Tensor](#2-the-massively-parallel-multidimensional-tensor)
...
To understand the implementations of deep learning frameworks such as `torch` and `jax` is the goal of [§2. The Massively Parallel Multidimensional Tensor](#2-the-massively-parallel-multidimensional-tensor).
...
<small>[$\hookleftarrow$ Table of Contents](#2-the-massively-parallel-multidimensional-tensor)</small><span class="gutter-figure gutter-figure-left" style="--margin-note-raise: 48px"><img src="./assets/iverson.png" alt="Kenneth E. Iverson at the blackboard"><span class="gutter-figure-caption">[Kenneth E. Iverson](https://en.wikipedia.org/wiki/Kenneth_E._Iverson)</span></span><span class="gutter-figure gutter-figure-right"><img src="./assets/iverson_book.png" alt="Iverson's 1962 A Programming Language"><span class="gutter-figure-caption">[*A Programming Language* (1962)](https://archive.org/details/aprogramminglanguage1962)</span></span>
...
- [2.1 Virtualizing Shapes with Strides]()
  ...
  - [2.1.6 Implementing Layer 0: `saxpy`, `sgemv` and `sgemm`]()

</div>

<small>[$\hookleftarrow$ Table of Contents (§2. The Massively Parallel Multidimensional Tensor)](#2-the-massively-parallel-multidimensional-tensor)</small>
...
Let's now learn about how we should architecture such a deep learning framework.
...
{{#nb 1.2_bigram.ipynb:8  hl=2,10-16,18,24}}
{{#nb 1.2_bigram.ipynb:9  hl=2,12-18,22,31}}
{{#nb 1.2_bigram.ipynb:10 hl=1-2}}
{{#nb 1.2_bigram.ipynb:11 hl=2-4}}
{{#nb 1.2_bigram.ipynb:12 hl=4-5,8}}
{{#nb 1.2_bigram.ipynb:2  hl=2}}
{{#nb 1.2_bigram.ipynb:3  hl=2}}
{{#nb 1.2_bigram.ipynb:5  hl=9,13-15}}
{{#nb 1.2_bigram.ipynb:6  hl=2,9,12-13}}
{{#nb 1.2_bigram.ipynb:7  hl=7-8}}

{{#nb 1.3_logistic_regression.ipynb:1 hl=2-3}}
{{#nb 1.3_logistic_regression.ipynb:2 hl=16-17}}
{{#nb 1.3_logistic_regression.ipynb:3 hl=2-3}}
{{#nb 1.3_logistic_regression.ipynb:4 hl=13}}


#### 2.1.2 Implementing Layer -1: A Stride Maps a Logical Shape to a Physical Storage
...
#### 2.1.3 Implementing Layer -1: Views and Indexing

<small>[$\hookleftarrow$ Table of Contents (§2.1 Virtualizing Shapes with Strides)](#11-from-certain-to-uncertain-knowledge)</small>


#### 2.1.4 Implementing Layer 0: Performance Primitives: `saxpy`, `sgemv` and `sgemm`
...
<small>[$\hookleftarrow$ Table of Contents (§2. The Massively Parallel Multidimensional Tensor)](#2-the-massively-parallel-multidimensional-tensor)</small><span class="gutter-figure gutter-figure-left" style="--margin-note-raise: 48px"><img src="./assets/wilkinson.png" alt="James Hardy Wilkinson at the blackboard"><span class="gutter-figure-caption">[James Hardy Wilkinson](https://en.wikipedia.org/wiki/James_H._Wilkinson)</span></span><span class="gutter-figure gutter-figure-right"><img src="./assets/wilkinson_paper.png" alt="Wilkinson's 1970 Turing Award lecture, Some Comments from a Numerical Analyst"><span class="gutter-figure-caption">[*Some Comments from a Numerical Analyst* (1971)](https://dl.acm.org/doi/10.1145/321637.321638)</span></span>
