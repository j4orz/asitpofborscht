...
and had to grapple with the infinite nature of the real numbers such as $\sqrt{2}$<span class="sidenote-number"></span><span class="sidenote">*See post-humously added Proposition 117 of Book X Euclid's Elements*</span>, $\pi$, and $e$.
...
<small>[$\hookleftarrow$ Table of Contents](#i-table-of-contents)</small><span class="gutter-figure gutter-figure-left"><img src="./assets/shannon.png" alt="Claude Shannon"></span><span class="gutter-figure gutter-figure-right"><img src="./assets/shannon_papers.png" alt="Shannon's 1948 A Mathematical Theory of Communication"></span>
...
<small>[$\hookleftarrow$ Table of Contents](#i-table-of-contents)</small><span class="gutter-figure gutter-figure-left" style="--margin-note-raise: 48px"><img src="./assets/rosenblatt.png" alt="Frank Rosenblatt at the Mark I Perceptron, Cornell Aeronautical Laboratory"></span><span class="gutter-figure gutter-figure-right"><img src="./assets/rosenblatt_paper.png" alt="Rosenblatt's 1958 The Perceptron: A Probabilistic Model for Information Storage and Organization in the Brain"></span>
...
- [2.2 Virtualizing Shapes with Strides]()
  - [2.2.1 A Stride Maps a Logical Shape to a Physical Storage]()
  - [2.2.2 Implementing vector addition `SAXPY`]()
  - [2.2.3 Implementing matrix vector multiplication `SGEMV`]()
  - [2.2.4 Implementing matrix matrix multiplication `SGEMM`]()
