...
- [Intermezzo One: The Language of Continuous Mathematics](#intermezzo-one-the-language-of-continuous-mathematics)
  ...
  - [I.4 Probability Spaces]()
  - [I.5 Random Variables and their Distributions]()
  - [I.6 Random Processes and their Kernels]()
  - [I.7 Measurable Spaces]()
- [2. The Multidimensional Parallelized Tensor](#2-the-massively-parallel-multidimensional-tensor)
  - [2.1 The Three Language Problem](#21-the-three-language-problem)
    - [2.1.1 From `python` to `rust`]()
    - [2.1.2 From `rust` to `risc-v`]()
    - [2.1.3 Instruction Sets, Pipelines, and Hierarchies]()
  - [2.2 Virtualizing Shapes with Strides](#22-virtualizing-shapes-with-strides)
...
- [Intermezzo Two: The Language of Numerical Analysis]()
  - [I.1 Conditioning, Stability, and Accuracy](#i1-probability-spaces)
...
How can the decision boundary $l$ be defined as a set of points satisfying the property that their weighted sum with the vector $\cparam{w}$ is 0? Where is the $y=mx+b$ we all know from high school?
...
- length with **Euclidean norm**<span class="defnote">**Euclidean norm**</span> $\mathscr{l}_1$
- length with **Manhattan norm**<span class="defnote">**Manhattan norm**</span> $\mathscr{l}_2$
...
- [2. The Massively Parallel Multidimensional Tensor](#2-from-ipls-array-to-apls-multidimensional-array)
  ...
  - [2.2 Virtualizing Shapes with Strides](#22-virtualizing-shapes-with-strides)
    ...
    - [2.2.2 Implementing vector addition `SAXPY`]()
    - [2.2.3 Implementing matrix vector multiplication `SGEMV`]()
    - [2.2.4 Matrix matrix multiplication `SGEMM`]()
  - [2.3 Accelerating Basic Linear Algebra on CPUs](#23-accelerating-matrix-multiplication-on-cpus) <!-- with computation and communication of rooflines -->
    - [2.3.1 Measuring Bottlenecks to Throughput with Roofline Plots]()
    - [2.3.2 Accelerating `SAXPY` on `RISC-V`]()
    - [2.3.3 Accelerating `SGEMV` on `RISC-V`]()
