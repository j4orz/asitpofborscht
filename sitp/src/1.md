...
- [1. Self-Supervised Sequence Learning with Single-Layer Networks](#1-sequence-learning)
  ...
  - [1.2 Next Token Prediction with ngrams](#12-next-token-prediction-with-ngrams)
  - [1.3 Lagniappe: Intelligence as Compression](#13-lagniappe-intelligence-as-compression)
  - [1.4 Categorical Parameterization with Logistic Regression](#14-categorical-parameterization-with-logistic-regression)
  - [1.5 Quantitative Redux with Linear Regression](#15-bias-variance-tradeoff) <!-- with least squared error -->
...
### 1.2 Next Token Prediction with ngrams
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>

<div class="toc">

- [1.2 Next Token Prediction with Bigrams]()
  - [1.2.1 The Estimation of Software 2.0](#121-the-estimation-of-software-20)
  - [1.2.2 Non-Parametric Estimation with Biased Histograms]()
  - [1.2.5 Loss Function with]()
...
The process of estimating distributions however  is the heart of machine learning and deep learning. which are simply functions also known as <span class="defnote">**function approximation**</span>**function approximation**.

Once a distribution like $p(w|\mathbf{h})$ is inferred from data by research labs,
users can use such a distribution in order to generate sentences with an inference loop,
...
Roughly speaking, the former is when you start with something and break it down whereas the latter is when you start with nothing and build it up.
Sometimes they are referred to with direction in time: synthesis is the forward direction whereas analysis is the backward.

The users of large language models are generating sentences with conditional distributions over the next word,
hence why this most recent wave of methods in software 2.0 is coloquially known
as <span class="defnote">**genAI**</span>**generative AI**<span class="sidenote-number"></span>.
For instance, in [§1.1 From Certain to Uncertain Knowledge](#11-from-certain-to-uncertain-knowledge)
we used GPT-2 to produce a conditional distribution $p(w|\text{Hello world, nice to})$ whose next-token prediction capability
was in turn used to generate full sentences with the inference loop.
In contrast, research engineers at frontier AI labs who are producers of large language models<span class="sidenote-number"></span><span class="sidenote">*Of course, this is falsely dichotomous, for research engineers also use the large language models that they produce.*</span>
are building the machinery required to produce such estimated distributions $p(w|\mathbf{h})$
*from* observed samples, namely the entire Internet.

<img src="./assets/probstat.png" />

<span class="defnote">**unsupervised learning**</span>**unsupervised learning**
<span class="defnote">**supervised learning**</span>**supervised learning**
<span class="defnote">**self-supervised learning**</span>**self-supervised learning**
<span class="defnote">**regression**</span>**regression**
<span class="defnote">**classification**</span>**classification**
<span class="defnote">**function approximation**</span>**function approximation**
...
<span class="defnote">**inputs**</span>**inputs**
<span class="defnote">**independent variable**</span>**independent variable**
<span class="defnote">**predictors**</span>**predictors**
<span class="defnote">**features**</span>**features**

<span class="defnote">**outputs**</span>**outputs**
<span class="defnote">**dependent variable**</span>**dependent variable**
<span class="defnote">**responses**</span>**responses**
<span class="defnote">**targets**</span>**targets**

#### 1.2.3 Non-Parametric Histogram with Markov Assumption
...
### 1.4 Categorical Parameterization with Logistic Regression
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
...
### 1.5 Quantitative Redux with Linear Regression  <!-- with Least Squared Error -->
<small>[$\hookleftarrow$ Table of Contents](#table-of-contents)</small>
