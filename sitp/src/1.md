...
to aid humans and fellow LLMs reading the code that the <img class="icon" src="./assets/borscht.png" alt="" style="aspect-ratio: 736 / 510;">[`borscht.Tensor`](https://numpy.org/doc/stable/reference/generated/numpy.ndarray.html) has a `.shape` of `(V, V)`, where in this case `V` evaluates to 5. We even assert such fact `assert p_VV.shape == (V, V)`.
