...
`torch` which will be able to run the training and inference of the said nets just trained in [§3]().
...
human feedback and by adding **reasoning**<span class="defnote">**reasoning**</span> in a **post-training**<span class="defnote">**post-training**</span> phase with
verifiable rewards.
...
<small>*[Gradient descent, how neural networks learn | Deep Learning Chapter 2 (3Blue1Brown 2017)](https://youtu.be/IHZwWFHWa-w?si=0Rn6f86aVCGYZ5zD)*</small>
...
motivate with a single perceptron not being able to separate non-linear functions (XOR)
