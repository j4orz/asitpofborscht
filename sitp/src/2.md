...
<small>From Modal GPU Glossary, modified from a diagram in Fabien Sanglard's blog , itself likely modified from a diagram in the CUDA C Programming Guide.</small>
