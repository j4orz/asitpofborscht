...
In part one of [The Structure and Intepretation of Tensor Programs](./front.md) you have developed a solid foundation in the
...
- [3. Self-Supervised Sequence Learning with Deep Networks]()
  ...
  - [3.2 Learning Sequences with FNNs]()
...
- [4. The Engine of Automatic Differentiation]()
  - [4.1 Automatic Differentiation]() <!-- tensor.forward, tensor.backward, tensor.optim -->
  - [4.2 Gradient-Based Optimization]()
  - [4.3 Accelerating Matrix Multiplication on GPUs](#24-accelerating-matrix-multiplication-on-gpus) <!-- simd to simt -->
  - [4.4 Accelerating Matrix Multiplication on TPUs](#25-accelerating-matrix-multiplication-on-tpus) <!-- gpu to tpu  -->
...
### 3.1 From Supervised to Self-Supervised Learning with Sequences

### 3.2 Learning Sequences with Linear Models
...
### 3.3 From Linear to Non-Linear Learning with Deep Neural Networks
...
<!-- ### 3.3 Learning Embeddings with Feedforward Neural Networks -->
<!-- <small>[$\hookleftarrow$ Table of Contents](#ii-neural-networks-1)</small> -->
...
### 3.4 Learning Sequences with Feedforward Neural Networks
<small>[$\hookleftarrow$ Table of Contents](#ii-neural-networks-1)</small>
...
### 4.1 From Numerical Linear Algebra to Deep Learning Frameworks
<small>[$\hookleftarrow$ Table of Contents](#ii-neural-networks-1)</small>
...
### 4.2 Network Primitives and Optimizers with `teenygrad.nn` and `teenygrad.optim`
<small>[$\hookleftarrow$ Table of Contents](#ii-neural-networks-1)</small>
...
### 4.3 Automatic Differentiation with `Tensor.forward()` and `Tensor.backward()`
<small>[$\hookleftarrow$ Table of Contents](#ii-neural-networks-1)</small>


### 4.4 From `SIMD` of Multi-Core Latency-Oriented Processors to `SIMT` of Many-Core Throughput-Oriented Processors with `PTX`
<small>[$\hookleftarrow$ Table of Contents](#ii-neural-networks-1)</small>

![](./assets/h100sm-blockdiagram-terminal.svg)


### 4.5 Accelerating `GEMV` on `GPU` with `CUDA Rust` via Rooflines
<small>[$\hookleftarrow$ Table of Contents](#ii-neural-networks-1)</small>
