...
— namely, we increase the expressivity of model architecture from linear perceptrons otherwise known as single-layer networks to non-linear **multi-layer perceptrons**<span class="defnote">**multi-layer perceptron**</span> or **deep neural networks**<span class="defnote">**deep neural network**</span>.
...
where *optimizing* said loss is the objective, which reduces to the problem of finding a set of parameters that minimizes such loss, denoted by
