...
you have developed a solid foundation in the mathematical preliminaries and statistical models used
...
you will evolve the implementation of [`borscht`]() from a numerical linear algebra library like `numpy`
...
- [3. Self-Supervised Sequence Learning with Deep Networks](#3-self-supervised-sequence-learning-with-deep-networks)
  - [3.1 Learning Representations with FFNs](#31-learning-representations-with-ffns)
    ...
    - [3.1.5 Optimization with Stochastic Gradient Descent via Backpropagation]()
...
- [4. The Engine of Automatic Differentiation](#4-the-engine-of-automatic-differentiation)
  - [4.1 Network Primitives](#41-network-primitives)
  ...
  - [4.2 Gradient-Based Optimization with Automatic Differentiation](#42-gradient-based-optimization-with-automatic-differentation) <!-- tensor.forward, tensor.backward, tensor.optim -->
  ...
  - [4.3 Accelerating Matrix Multiplication on GPUs](#43-accelerating-the-blas-on-gpus) <!-- simd to simt -->
  ...
  - [4.4 Accelerating Matrix Multiplication on TPUs]() <!-- gpu to tpu  -->
...
### 4.2 Gradient-Based Optimization with Automatic Differentation <!-- borscht.forward(), borscht.backward() -->
