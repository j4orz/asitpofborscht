...
Welcome young hacker! Glad to see you here. In part one of [The Structure and Intepretation of Tensor Programs](./front.md)
...
by specifying and optimizing a parameterized loss function
with stochastic and infintely continuous descriptions of software 2.0<span class="sidenote-number"></span><span class="sidenote">*See [Appendix B](./ap.md#b-from-symbolic-software-10-to-stochastic-software-20) for more philosophical and historical motivation following Wittgenstein. Roughly speaking, software 1.0 is attempting to describe a reality with too many parts to count.*</span>.
...
with magic-like technology such as Google Translate, Apple Siri, and Tesla Autopilot,
but most recently with OpenAI's ChatGPT whose core loss function you already understand
to be the cross entropy loss on next token prediction.
It's amazing how close you are to deep neural nets and the transformer architecture
powering ChatGPT without even knowing. This is what we'll get into in this second part of the book.
...
We will start from **feedforward neural networks**<span class="defnote">**FFN**</span>,
and move on to other architecture variants with **convolutional neural networks**<span class="defnote">**CNN**</span>
**recurrent neural networks**<span class="defnote">**RNN**</span>, and finally, **generative pre-trained transformers**<span class="defnote">**GPT**</span>,
...
which were all explored during the 2012-2019 time period of what is coloqially known as the **age of research**<span class="defnote">**the age of research**</span>.
...
a full blown batteries-included deep learning framework like [**PyTorch**](https://pytorch.org/)'s
`torch` which will be able to run the training and inference of the nets you just said trained in [§3]().
This means implementing the **optimizers**<span class="defnote">**optimizers**</span>
for neural networks whose evaluations are accelerated with massively parallel processors known as
**GPUs**<span class="defnote">**GPU**</span>
whose gradients are automatically evaluated with an **automatic differentation**<span class="defnote">**automatic differentiation**</span> engine.
...
by turning the stochastic parrots from **pre-training**<span class="defnote">**pre-training**</span>
into **assistants**<span class="defnote">**assistants**</span> with a **mid-training**<span class="defnote">**mid-training**</span> phase of reinforcement learning with
human feedback<span class="sidenote-number"></span><span class="sidenote">*Originally presented in [Introducing ChatGPT (OpenAI 2022)](https://openai.com/index/chatgpt/), and reproduced by open source in [Llama 2: Open Foundation and Fine-Tuned Chat Models (Touvron et al. 2023)](https://arxiv.org/pdf/2307.09288)*</span>
and by adding **reasoning**<span class="defnote">**reasoning**</span> in a **post-training**<span class="defnote">**post-training**</span> phase with
verifiable rewards<span class="sidenote-number"></span><span class="sidenote">*Originally presented in [Introducing OpenAI o1 (OpenAI 2024)](https://openai.com/o1/), and reproduced by open source in [DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning](https://arxiv.org/pdf/2501.12948)*</span>.
...
- [3. Self-Supervised Sequence Learning with Deep Networks](#3-self-supervised-sequence-learning-with-deep-networks)
  - [3.1 Optimization with Gradient Descent](#31-optimization-with-gradient-descent)
    - [3.1.1 Foo]()
    - [3.1.2 Bar]()
  - [3.2 Learning Representations with FNNs](#32-learning-representations-with-ffns)
    - [3.2.1 Linear Architectures with Non-Linear Data](#321-architecture-with-lots-of-linear-regression)
    - [3.2.2 Architecture with Lots of Linear Regression](#321-architecture-with-lots-of-linear-regression)
    - [3.2.3 Loss Function with Cross Entropy](#322-loss-function-with-cross-entropy)
    - [3.2.4 Optimization with (Stochastic) Gradient Descent](#323-optimization-with-stochastic-gradient-descent)
...
- [4. The Engine of Automatic Differentiation](#4-the-engine-of-automatic-differentiation)
  - [4.1 Automatic Differentiation](#41-automatic-differentation) <!-- tensor.forward, tensor.backward, tensor.optim -->
  ...
  - [4.2 Gradient-Based Optimization](#42-gradient-based-optimization)
  ...
  - [4.3 Network Primitives](#43-network-primitives)
...
### 3.1 Optimization with Gradient Descent

> In which we transition from direct to iterative optimization methods, given that most neural networks that we will encounter are highly non-convex.
...
[Gradient descent, how neural networks learn | Deep Learning Chapter 2 (3Blue1Brown 2017)](https://youtu.be/IHZwWFHWa-w?si=0Rn6f86aVCGYZ5zD)

### 3.2 Learning Representations with FFNs
...
- [3.2 Learning Representations with FFNs](#32-learning-representations-with-ffns)
  - [3.2.1 Linear Architectures with Non-LinearO Data]()
  - [3.2.2 Architecture with Lots of Linear Regression]()
  - [3.2.3 Loss Function with Cross Entropy]()
  - [3.2.4 Optimization with (Stochastic) Gradient Descent]()
  - [3.2.4 Representation Learning]()

</div>


#### 3.2.1 Architecture with Lots of Linear Regression
...
[But what is a neural network? | Deep learning chapter 1 (3Blue1Brown 2017)](https://youtu.be/IHZwWFHWa-w?si=0Rn6f86aVCGYZ5zD)
...
#### 3.2.2 Loss Function with Cross Entropy
#### 3.2.3 Optimization with (Stochastic) Gradient Descent

### 3.3 Learning Representations with CNNs
<small>[$\hookleftarrow$ Table of Contents](#ii-neural-networks-1)</small>
...
### 4.1 Automatic Differentation <!-- borscht.forward(), borscht.backward() -->
<small>[$\hookleftarrow$ Table of Contents](#ii-neural-networks-1)</small>
...
### 4.5 Accelerating Matrix Multiplication on TPUs
