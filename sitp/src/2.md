...
<small>[$\hookleftarrow$ Table of Contents](#ii-table-of-contents)</small><span class="gutter-figure gutter-figure-left" style="--margin-note-raise: 48px"><img src="./assets/hinton.png" alt="Geoffrey Hinton"><span class="gutter-figure-caption">[Geoffrey Hinton](https://en.wikipedia.org/wiki/Geoffrey_Hinton) (Turing Award 2018)</span></span><span class="gutter-figure gutter-figure-right"><img src="./assets/hinton_paper.png" alt="Rumelhart, Hinton and Williams' Learning representations by back-propagating errors (Nature 1986)"><span class="gutter-figure-caption">[*Learning representations by back-propagating errors* (1986)](https://www.cs.toronto.edu/~hinton/absps/naturebp.pdf)</span></span>
