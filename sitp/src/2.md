...
- [3. Self-Supervised Sequence Learning with Deep Networks](#3-self-supervised-sequence-learning-with-deep-networks)
  - [3.1 Learning Representations with FFNs](#32-learning-representations-with-ffns)
    ...
    - [3.1.2 Architecture with Lots of Linear Regression](#321-architecture-with-lots-of-linear-regression)
...
- [3.1 Learning Representations with FFNs](#32-learning-representations-with-ffns)
  - [3.1.1 Linear Architectures on Non-Linear Data]()
  - [3.1.2 From Perceptrons to Multi Layer Perceptron]()
  - [3.1.3 Loss Function with Cross Entropy]()
  - [3.1.4 Optimization with Stochastic Gradient Descent]()
...
Quisque ipsum massa, mollis eget ligula eget, tincidunt pellentesque nibh. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Curabitur metus libero, pharetra at lorem vel, fringilla elementum lectus. Vestibulum orci sem, interdum in sapien eget, ullamcorper consequat erat. Cras dignissim sed sapien ac vulputate. Fusce et arcu nec mauris imperdiet posuere. Duis malesuada sapien vitae condimentum porta. Integer faucibus sed sem ac scelerisque. Vivamus scelerisque justo vitae ultricies sodales. Sed leo ligula, viverra ac mi at, pulvinar scelerisque mi. Nulla quis sapien sollicitudin, faucibus sem in, viverra orci. Suspendisse malesuada urna enim, id venenatis quam placerat nec. Praesent in mauris sodales, tempus dolor non, tempor urna. Aliquam sollicitudin diam a sagittis accumsan. Sed laoreet, massa eu venenatis porta, elit libero mattis elit, vel placerat nibh justo vel arcu. Nulla et turpis vitae massa consequat dapibus.

Sed fringilla consequat odio, vel luctus purus laoreet nec. Vivamus accumsan gravida augue ut porttitor. Vestibulum elit dolor, congue sit amet augue nec, viverra bibendum tortor. Phasellus id arcu vel quam iaculis malesuada. Vestibulum nulla neque, dapibus a sem vel, suscipit tincidunt lacus. Mauris vestibulum placerat velit, eu varius mi tincidunt at. Praesent luctus vulputate tortor, a tincidunt ex molestie quis. Aliquam sagittis tellus semper cursus sagittis. In efficitur faucibus enim, id fermentum ante sodales ac. Nulla sit amet risus sit amet est venenatis interdum. In non odio quis ipsum pharetra faucibus. Cras finibus, ante sit amet auctor pulvinar, nunc tellus faucibus magna, ac hendrerit ipsum ligula eu velit. Duis nec nisi scelerisque, rhoncus magna vel, elementum tortor.
...
- [3.1 Optimization with Gradient Descent](#31-optimization-with-gradient-descent)
  - [3.1.1 From Decompositions to Gradient Descent]()
  - [3.1.2 The Gradient]()
...
[Transformers, the tech behind LLMs | Deep Learning Chapter 5 (3Blue1Brown 2024)](https://youtu.be/wjZofJX0v4M?si=y4i1t4gMsPuvk_ll)
