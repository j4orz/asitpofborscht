...
- [3. Self-Supervised Sequence Learning with Deep Networks](#3-self-supervised-sequence-learning-with-deep-networks)
  - [3.1 Learning Representations with FFNs](#31-learning-representations-with-ffns)
    - [3.1.1 From Linear Perceptrons to Non-Linear Multi Layer Perceptrons](#311-from-linear-perceptrons-to-non-linear-multi-layer-perceptrons)
...
- [Intermezzo Three: The Language of Transformers](#intermezzo-three-the-language-of-transformers)
  - [I3.1 Real Analysis, Derivatives in Hilbert Spaces]() <!-- inner product. expand for muon -->
  - [I3.2 Superposition]()
...
#### 3.1.1 From Linear Perceptrons to Non-Linear Multi Layer Perceptrons
...
### I3.1 Derivatives in Vector Spaces
