...
- [3. Self-Supervised Sequence Learning with Deep Networks](#3-self-supervised-sequence-learning-with-deep-networks)
  - [3.1 Learning Representations with FFNs](#32-learning-representations-with-ffns)
    - [3.1.1 Linear Architectures with Non-Linear Data](#321-architecture-with-lots-of-linear-regression)
    - [3.1.2 Architecture with Lots of Linear Regression](#321-architecture-with-lots-of-linear-regression)
    - [3.1.3 Loss Function with Cross Entropy](#322-loss-function-with-cross-entropy)
    - [3.1.4 Optimization with Stochastic Gradient Descent](#323-optimization-with-stochastic-gradient-descent)
  - [3.2 Iterative Optimization](#31-optimization-with-gradient-descent)
...
- [4. The Engine of Automatic Differentiation](#4-the-engine-of-automatic-differentiation)
  ...
  - [4.2 Gradient-Based Optimization with Automatic Differentiation](#41-automatic-differentation) <!-- tensor.forward, tensor.backward, tensor.optim -->
  ...
  - [4.3 Accelerating Matrix Multiplication on GPUs]() <!-- simd to simt -->
