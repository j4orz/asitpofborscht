...
Namely, in [§3. Self-Supervised Sequence Learning with Deep Networks](#3-self-supervised-sequence-learning-with-deep-networks),
you will increase the expressivity of model architecture from linear perceptrons otherwise known as single-layer networks to non-linear **multi-layer perceptrons**<span class="defnote">**multi-layer perceptron**</span> or **deep neural networks**<span class="defnote">**deep neural network**</span>.
...
<!-- you have developed foundation in the mathematical preliminaries
of stochastic and infintely continuous descriptions
used throughout the statistical learning approach to artificial intelligence.
That is, instead of test our programs with unit tests, we evaluate them on their ability to predict the next token; there also remains a specification, but using
the types of high dimensional objects from linear algebra rather than discrete combinatorial ones; with the implementation, programs are grown
by searching for a specific instance of parameters rather than coded line by line.
Writ large, the discipline of machine learning writ large recovers such a program from data by specifying a parameterized architecture scored by a loss function and optimizing such loss. -->
...
for neural network primitives whose evaluations are accelerated with massively parallel processors known as **graphics processing units**<span class="defnote">**GPU**</span> (<span class="smallcaps">GPUs</span>)
...
- [3. Self-Supervised Sequence Learning with Deep Networks](#3-self-supervised-sequence-learning-with-deep-networks)
  - [3.1 Learning Representations with <span class="smallcaps">FFNs</span>](#31-learning-representations-with-ffns)
    - [3.1.1 From Localist to Distributional Representations](#311-from-localist-to-distributional-representations)
    - [3.1.2 From Linear Perceptrons to Non-Linear Multi Layer Perceptrons](#312-from-linear-perceptrons-to-non-linear-multi-layer-perceptrons)
    - [3.1.3 From Direct to Iterative Optimization](#313-from-direct-to-iterative-optimization)
...
> In which we have our second encounter with the language modeling of <span class="smallcaps">GPT-2</span> via <img class="icon" src="./assets/borscht.png" alt="" style="aspect-ratio: 736 / 510;">`borscht`, namely, in addition to the compressive next-token prediction, the non-linear distributed representation learning that happens with embeddings when iteratively optimizing such multi-layer perceptrons via gradient descent.
...
<iframe height="500px" loading="lazy" src="https://www.youtube.com/embed/wjZofJX0v4M?si=6GPGcxx1VQo6VVY0&amp;start=444" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec auctor risus id dictum tincidunt. Nunc tristique convallis lectus in efficitur. Nunc mollis neque sapien, a tempus erat congue sit amet. Pellentesque non ex sit amet enim tincidunt blandit non ac justo. Sed a felis consequat, egestas neque ac, ultrices ante. Nam semper nec dui in cursus. Ut ac condimentum nisi. Suspendisse viverra interdum lectus id egestas. Ut sodales finibus arcu, eu consequat mauris egestas eu.

Nam neque felis, consectetur vitae imperdiet non, tempor eu nibh. Morbi vitae quam nibh. Integer maximus iaculis accumsan. Donec elementum non magna vitae aliquam. Praesent egestas condimentum nisi sit amet fringilla. Morbi eu quam vitae arcu molestie posuere. Phasellus porta eget quam et dignissim. Aliquam ultricies ante nunc, eu venenatis quam consequat vitae. Donec gravida mauris risus, sed posuere ipsum lobortis vitae. Etiam hendrerit nec turpis et pretium.
...
### 4.1.2 Forward Mode with <img class="icon" src="./assets/borscht.png" alt="" style="aspect-ratio: 736 / 510;">`borscht.forward()`
...
### 4.1.3 Backward Mode with <img class="icon" src="./assets/borscht.png" alt="" style="aspect-ratio: 736 / 510;">`borscht.backward()`
