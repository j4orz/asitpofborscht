...
- [3. Self-Supervised Sequence Learning with Deep Networks](#3-self-supervised-sequence-learning-with-deep-networks)
  ...
  - [3.2 Iterative Optimization](#32-iterative-optimization)
    ...
    - [3.2.2 First Order Optimization with Gradient Descent]()
    - [3.2.3 First Order Optimization with Steepest Descent]()
    - [3.2.4 Second Order Optimization with Newton's Method](#322-second-order-optimization-with-newtons-method)
