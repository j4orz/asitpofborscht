...
Although using the precise tools of mathematics to specify architectures, loss functions,
and optimizers, the *essence* of the discipline is more akin to synthetic chemistry or microbiology which *grow* chemicals and cells.
...
**embedding**<span class="defnote">**embedding**</span> (expand).
We will start from **feedforward neural networks**<span class="defnote">**FFN**</span> (<span class="smallcaps">FFN</span>),
and move on to other architecture variants with **convolutional neural networks**<span class="defnote">**CNN**</span> (<span class="smallcaps">CNN</span>),
...
After completing [Part II. Neural Networks](./2.md), you will be ready for [Part III. Scaling Networks](./3.md) of the book where we finally achieve our quest of building our own <span class="smallcaps">ChatGPT</span>
following <span class="smallcaps">Nanochat</span> and subsequently, <span class="smallcaps">PyTorch 2</span> with <img class="icon" src="./assets/borscht.png" alt="" style="aspect-ratio: 736 / 510;">[`borscht.compile()`]() and <img class="icon" src="./assets/borscht.png" alt="" style="aspect-ratio: 736 / 510;">[`borscht.distributed()`]().
...
- [3. Self-Supervised Sequence Learning with Deep Networks](#3-self-supervised-sequence-learning-with-deep-networks)
  ...
  - [3.2 Iterative Optimization](#32-iterative-optimization)
    ...
    - [3.2.2 Second Order Optimization with Newton's Method](#322-second-order-optimization-with-newtons-method)
...
- [Intermezzo Three: The Language of Neural Networks](#intermezzo-three-the-language-of-neural-networks)
  ...
  - [I3.2 Derivatives in Hilbert Spaces](#i32-derivatives-in-hilbert-spaces)
  - [I3.3 Superposition]()
...
<small>[$\hookleftarrow$ Table of Contents](#ii-table-of-contents)</small><span class="gutter-figure gutter-figure-left" style="--margin-note-raise: 48px"><img src="./assets/bengio.png" alt="Yoshua Bengio"><span class="gutter-figure-caption">[Yoshua Bengio](https://en.wikipedia.org/wiki/Yoshua_Bengio) (Turing Award 2018)</span></span><span class="gutter-figure gutter-figure-right"><img src="./assets/bengio_paper.png" alt="Bengio, Ducharme and Vincent's A Neural Probabilistic Language Model (NIPS 2000)"><span class="gutter-figure-caption">[*A Neural Probabilistic Language Model* (2000)](https://papers.nips.cc/paper_files/paper/2000/hash/728f206c2a01bf572b5940d7d9a8fa4c-Abstract.html)</span></span>

> In which we have our second encounter with the language modeling of GPT-2 via <img class="icon" src="./assets/borscht.png" alt="" style="aspect-ratio: 736 / 510;">`borscht`, namely, in addition to the compressive next-token prediction, the non-linear distributed representation learning that happens with embeddings when iteratively optimizing such multi-layer perceptrons via gradient descent.
...
| 2.0 goal | 2.0 method (part i) | 2.0 method (part ii) |
|---|---|---|
...
<span class="mod">Linear</span>
<span class="mod">ReLU</span>
<span class="mod">Embed</span>
<span class="mod">Conv2D</span>
<span class="mod">Attention</span>
...
<small>[$\hookleftarrow$ Table of Contents](#ii-table-of-contents)</small><span class="gutter-figure gutter-figure-left" style="--margin-note-raise: 48px"><img src="./assets/newton.png" alt="Isaac Newton, painted by Godfrey Kneller in 1689"><span class="gutter-figure-caption">[Isaac Newton](https://en.wikipedia.org/wiki/Isaac_Newton)</span></span><span class="gutter-figure gutter-figure-right"><img src="./assets/newton_paper.png" alt="Newton's 1687 Philosophiae Naturalis Principia Mathematica"><span class="gutter-figure-caption">[*Philosophiæ Naturalis Principia Mathematica* (1687)](https://archive.org/details/philosophiaenatu00newt_0/page/n10/mode/2up)</span></span>
...
<small>[$\hookleftarrow$ Table of Contents](#ii-table-of-contents)</small><span class="gutter-figure gutter-figure-left" style="--margin-note-raise: 48px"><img src="./assets/lecun.png" alt="Yann LeCun"><span class="gutter-figure-caption">[Yann LeCun](https://en.wikipedia.org/wiki/Yann_LeCun) (Turing Award 2018)</span></span><span class="gutter-figure gutter-figure-right"><img src="./assets/lecun_paper.png" alt="LeCun and Bengio's Convolutional Networks for Images, Speech, and Time-Series"><span class="gutter-figure-caption">[*Convolutional Networks for Images, Speech, and Time-Series* (1995)](http://yann.lecun.com/exdb/publis/pdf/lecun-bengio-95a.pdf)</span></span>
