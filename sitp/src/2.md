...
but most recently with <span class="smallcaps">ChatGPT</span> and <span class="smallcaps">Claude</span> whose core loss function you already understand
...
powering <span class="smallcaps">ChatGPT</span> without even knowing. This is what we'll cover in this second part of <span class="smallcaps">SITP</span>.
...
After completing [Part II. Neural Networks](./2.md), you will be ready for [Part III. Scaling Networks](./3.md) of the book where we finally achieve our quest of building our own [<span class="smallcaps">ChatGPT</span>](https://chatgpt.com/)
following [`karpathy/nanochat`](https://github.com/karpathy/nanogpt) and subsequently, [<span class="smallcaps">PyTorch 2</span>](https://pytorch.org/get-started/pytorch-2-x/) with [`borscht.compile()`]() and [`borscht.distributed()`]().
...
- [3.1 Learning Representations with FFNs](#31-learning-representations-with-ffns)
  - [3.1.1 From Localist to Distributional Representations](#312-from-localist-to-distributional-representations)
  - [3.1.2 From Linear Perceptrons to Non-Linear Multi Layer Perceptrons](#311-from-linear-perceptrons-to-non-linear-multi-layer-perceptrons)
  - [3.1.3 From Direct to Iterative Optimization](#313-from-direct-to-iterative-optimization)
...
Similarly, so too of Rosenblatt's machine learning before Bengio, Hinton, and LeCun's deep learning.
...
|---|---|---|
| evaluation | next-token prediction with stochastics of probability theory | next-token prediction with stochastics of probability theory |
...
| optimizers | direct solvers with approximation of differential calculus | iterative solvers with approximation of differential calculus |
...
and [(Bishop 2025)](https://www.microsoft.com/en-us/research/people/cmbishop/prml-book/)<span class="sidenote-number"></span><span class="sidenote">*Similarly, you can also take a look at [(Goodfellow et al., 2017)]()*</span> for statistical machine learning more generally.
