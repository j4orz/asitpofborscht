...
My alma matter was amongst those which took the SICP approach<span class="sidenote-number"></span><span class="sidenote">*Actually it's Scheming dual, [HtDP](https://htdp.org/). Thank you [Professor. Vasiga](https://cs.uwaterloo.ca/~tmjvasig/), and [Professor Ragde](https://cs.uwaterloo.ca/~plragde/flaneries/) for bringing over HtDP to our school!*</span>, and as intended,
for someone coming into first year college have taken computer science in high school<span class="sidenote-number"></span><span class="sidenote">*Thank you to Professor Vasiga once again actually for [cscircles](https://cscircles.cemc.uwaterloo.ca/) and thank you Mr. Gould for offering a computer engineering course!*</span>, it blew my mind.
...
my knowledge felt quite fragmented as I personally forgot lots of foundation from college<span class="sidenote-number"></span><span class="sidenote">*Maybe I had the defiition of a basis in the basement of my subconscious. Thank you [Professor. Wolczuk](https://wolczuk.com/)!*</span>,
